    ...
    public partial class InitialCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditReports", x => x.ReportID);
                });
            ...
            migrationBuilder.CreateTable(
                name: "MortgageApplicants",
                columns: table => new
                {
                    ApplicantID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PersonId = table.Column<int>(type: "int", nullable: false),
                    CreditReportReportID = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MortgageApplicants", x => x.ApplicantID);
                    table.ForeignKey(
                        name: "FK_MortgageApplicants_CreditReports_CreditReportReportID",
                        column: x => x.CreditReportReportID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanOfficerOfficerId = table.Column<int>(type: "int", nullable: true),
                    MortgageApplicantApplicantID = table.Column<int>(type: "int", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mortgages_LoanOfficers_LoanOfficerOfficerId",
                        column: x => x.LoanOfficerOfficerId,
                        principalTable: "LoanOfficers",
                        principalColumn: "OfficerId");
                    table.ForeignKey(
                        name: "FK_Mortgages_MortgageApplicants_MortgageApplicantApplicantID",
                        column: x => x.MortgageApplicantApplicantID,
                        principalTable: "MortgageApplicants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanOfficers_PersonId",
                table: "LoanOfficers",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_MortgageApplicants_CreditReportReportID",
                table: "MortgageApplicants",
                column: "CreditReportReportID");

            migrationBuilder.CreateIndex(
                name: "IX_MortgageApplicants_PersonId",
                table: "MortgageApplicants",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Mortgages_LoanOfficerOfficerId",
                table: "Mortgages",
                column: "LoanOfficerOfficerId");

            migrationBuilder.CreateIndex(
                name: "IX_Mortgages_MortgageApplicantApplicantID",
                table: "Mortgages",
                column: "MortgageApplicantApplicantID");
        }
